...
void main(List<String> args) async {
  ...
  File file_command_gh_push_short =
      File(join(Directory.current.path, "command_gh_push_short.sh"));
  await file_command_gh_push_short.writeAsString("");
  File file_command_gh_push_long =
      File(join(Directory.current.path, "command_gh_push_long.sh"));
...
git init
git branch -M main
git remote add origin https://github.com/General-Developer/outetts
git remote set-url --push origin https://General-Developer:{main_github_token}@github.com/General-Developer/outetts
...
'''
  ...
  for (var i = 0; i < rawPaths.length; i++) {
    if (["command_gh_push_long.sh", "command_gh_push_short.sh"]
        .contains(basename(rawPaths[i]).trim())) {
      continue;
    }
    if (RegExp(r"(\.git|/\.git|/\.git/|\.dart_tool)", caseSensitive: false)
