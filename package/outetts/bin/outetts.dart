...
// import 'package:outetts/babylon/src/bindings.dart';
// import "package:path/path.dart" as path;

// class TextToSpeechOutetts {
...
//   final TextToSpeechOutetts textToSpeechOutetts = TextToSpeechOutetts(
//     directoryTemp: Directory(path.join(Directory.current.path, "temp")),
//   );

//   await textToSpeechOutetts.init();

//   final String text = "Hello World";
//   final result = textToSpeechOutetts.createSpeech(text: text);
//   print(result);
